...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <div class="header">
                <h1><i class="fas fa-truck me-2"></i>Vehicle Management</h1>
                <p>Manage and monitor all service vehicles in the EV Mobile Station network</p>
            </div>
                    ...
                    <?php foreach ($filtered_vehicles as $vehicle): ?>
                        <div class="vehicle-card">
                            ...
                            <div class="vehicle-actions">
                                ...
                                <?php endif; ?>
                                <button class="btn btn-danger btn-sm" onclick="deleteVehicle(<?php echo $vehicle['id']; ?>)">
